...
STUDENTS = {
    '1': {'name': 'Ishita', 'age': 19, 'spec': 'computer science'},
    '2': {'name': 'Shruti', 'age': 20, 'spec': 'Biotechnology'},
    '3': {'name': 'Harsh,', 'age': 20, 'spec': 'Mechanical'},
    '4': {'name': 'Tushar', 'age': 19, 'spec': 'Aerospace'},
}
